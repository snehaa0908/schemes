...
<br>
<b>TO ADD A SCHEME : </b><a class="btn btn-danger"style="width:150px; heigth:50px;" href="senioradd.php"><b><i class="fas fa-hand-point-right"></i> ADD</b></a>
<br>
<?php
        ...
        $sql = "SELECT id,scheme,details from list";
        ...
        if ($result-> num_rows > 0)
        {
            ...
            <td><a class="btn btn-success"style="width:150px; heigth:50px;" href="senioradmin.php?id=<?php echo $row['id'] ?>">DELETE</a></td>
            </tr></div>
            <?php
            }
        }
...
if(isset($_GET['id'])){
	...
	if($query){
        ...
        header("Refresh:0;url=senioradmin.php");
