...
<br>
<b>TO ADD A SCHEME : </b><a class="btn btn-danger"style="width:150px; heigth:50px;" href="disabledadd.php"><b><i class="fas fa-hand-point-right"></i> ADD</b></a>
<br>
<?php
        ...
        if ($result-> num_rows > 0)
        {
            ...
            <td><a class="btn btn-success"style="width:150px; heigth:50px;" href="disabledadmin.php?id=<?php echo $row['id'] ?>">DELETE</a></td>
            </tr></div>
            <?php
            }
        }
...
if(isset($_GET['id'])){
	$Id=$_GET['id'];
	$del="DELETE FROM listp WHERE $Id=id";
